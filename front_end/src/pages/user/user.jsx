      ...
      <div className="user-container">
        <div classsName="user-left-bar">
          <ul>
            ...
            <li onClick={() => setMode(0)} className={ mode === 0 ? 'selected' : '' }>บัญชีของฉัน</li>
            <li onClick={() => setMode(1)} className={ mode === 1 ? 'selected' : '' }>เงินในบัญชี</li>
            <li onClick={() => setMode(2)} className={ mode === 2 ? 'selected' : '' }>ที่อยู่</li>
            <li onClick={() => setMode(3)} className={ mode === 3 ? 'selected' : '' }>ตั้งค่ารหัสผ่าน</li>
