        ...
        <div className="content">
          <div className="form-container">
            <form action="">
              ...
              <div className="extra">
                <p><input type="checkbox" required />ฉันยอมรับ <a onClick={() => onOpenTerms()}>ข้อตกลงและเงื่อนไข</a></p>
              </div>
